...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (1, 1, 1, 'SINGLE_CHOICE', '我很明了本测验的说明');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (2, 2, 1, 'SINGLE_CHOICE', '我对本测验每个问题都会按自己的真实情况作答');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (3, 3, 1, 'SINGLE_CHOICE', '有度假机会时,我宁愿');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (4, 4, 1, 'SINGLE_CHOICE', '我有足够的能力应付困难');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (5, 5, 1, 'SINGLE_CHOICE', '即使是关在铁笼内的猛兽,我见了也会惴惴不安');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (6, 6, 1, 'SINGLE_CHOICE', '我总避免批评别人的言行');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (7, 7, 1, 'SINGLE_CHOICE', '我的思想似乎:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (8, 8, 1, 'SINGLE_CHOICE', '我不擅长说笑话讲趣事');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (9, 9, 1, 'SINGLE_CHOICE', '当我看到亲友邻居争执时,我总是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (10, 10, 1, 'SINGLE_CHOICE', '在社交场合中,我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (11, 11, 1, 'SINGLE_CHOICE', '我愿做一名');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (12, 12, 1, 'SINGLE_CHOICE', '阅读时,我宁愿选读');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (13, 13, 1, 'SINGLE_CHOICE', '我相信许多人都有些心理不正常，但他们都不愿意这样承认');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (14, 14, 1, 'SINGLE_CHOICE', '我所希望的结婚对象应擅长交际而无须有文艺才能');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (15, 15, 1, 'SINGLE_CHOICE', '对于头脑简单和不讲理的人,我仍然能待之以礼');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (16, 16, 1, 'SINGLE_CHOICE', '受人侍奉时我常感到不安');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (17, 17, 1, 'SINGLE_CHOICE', '从事体力或脑力劳动后，我比平常人需要更多的休息才能恢复工作效率');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (18, 18, 1, 'SINGLE_CHOICE', '半夜醒来,我会为种种忧虑而不能再入眠');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (19, 19, 1, 'SINGLE_CHOICE', '事情进行不顺利时,我常会急得掉眼泪');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (20, 20, 1, 'SINGLE_CHOICE', '我认为只要双方同意就可以离婚，不应当受传统礼教的束缚');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (21, 21, 1, 'SINGLE_CHOICE', '我对于人或物的兴趣都很容易改变');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (22, 22, 1, 'SINGLE_CHOICE', '筹划事务时,我宁愿:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (23, 23, 1, 'SINGLE_CHOICE', '我常会无端地自言自语:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (24, 24, 1, 'SINGLE_CHOICE', '无论工作,饮食或出游,我总');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (25, 25, 1, 'SINGLE_CHOICE', '有时我会怀疑别人是否对我的言谈真正有兴趣');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (26, 26, 1, 'SINGLE_CHOICE', '在工厂中,我宁愿负责');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (27, 27, 1, 'SINGLE_CHOICE', '在阅读时,我宁愿选读');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (28, 28, 1, 'SINGLE_CHOICE', '下列三个字中哪个字与其它两个字属于不同类别');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (29, 29, 1, 'SINGLE_CHOICE', '如果我能重新做人,我要');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (30, 30, 1, 'SINGLE_CHOICE', '在我的一生中,我总能达到我所预期的目标');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (31, 31, 1, 'SINGLE_CHOICE', '当我说谎时,我总觉得内心不安,不敢正视对方');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (32, 32, 1, 'SINGLE_CHOICE', '假使我手持一支装有子弹的手枪，我必须取出子弹后才能心安');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (33, 33, 1, 'SINGLE_CHOICE', '朋友们大都认为我是一个说话有风趣的人');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (34, 34, 1, 'SINGLE_CHOICE', '如果人们知道我的内心世界,他们都会感到惊讶');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (35, 35, 1, 'SINGLE_CHOICE', '在社交场合中,如果我突然成为众所注意的中心,我会感到局促不安');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (36, 36, 1, 'SINGLE_CHOICE', '我总喜欢参加规模庞大的聚会,舞会或公共集会');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (37, 37, 1, 'SINGLE_CHOICE', '在下列工作中,我喜欢的是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (38, 38, 1, 'SINGLE_CHOICE', '我常常怀疑那些出乎意料的,对我过于友善的人的诚实动机');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (39, 39, 1, 'SINGLE_CHOICE', '我宁愿自己的生活象');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (40, 40, 1, 'SINGLE_CHOICE', '目前世界所需要的是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (41, 41, 1, 'SINGLE_CHOICE', '有时候我觉得我需要做剧烈的体力活动');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (42, 42, 1, 'SINGLE_CHOICE', '我愿意与有礼貌有教养的人来往，而不愿和粗鲁野蛮的人为伍');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (43, 43, 1, 'SINGLE_CHOICE', '在处理一些必须凭借智慧的事务中,我的父母的确');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (44, 44, 1, 'SINGLE_CHOICE', '当上司(或教师)召见我时,我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (45, 45, 1, 'SINGLE_CHOICE', '假使薪俸优厚,我愿意专任照料精神病人的职务');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (46, 46, 1, 'SINGLE_CHOICE', '看报时,我喜欢读');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (47, 47, 1, 'SINGLE_CHOICE', '我曾担任过');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (48, 48, 1, 'SINGLE_CHOICE', '逛街时,我宁愿观看一个画家写生,而不愿听人家的辩论');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (49, 49, 1, 'SINGLE_CHOICE', '我的神经脆弱,稍有刺激的声音就会使我战栗');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (50, 50, 1, 'SINGLE_CHOICE', '我在清晨起身时,就常常感到疲乏不堪');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (51, 51, 1, 'SINGLE_CHOICE', '我宁愿是一个');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (52, 52, 1, 'SINGLE_CHOICE', '每逢年节或亲友生日,我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (53, 53, 1, 'SINGLE_CHOICE', '下列数字中,哪个数字与其他两个数字属于不同类别');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (54, 54, 1, 'SINGLE_CHOICE', '[猫]与[鱼]就如同[牛]与');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (55, 55, 1, 'SINGLE_CHOICE', '在做人处事的各个方面,我的父母很值得敬佩');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (56, 56, 1, 'SINGLE_CHOICE', '我觉得我有一些别人所不及的优良品质');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (57, 57, 1, 'SINGLE_CHOICE', '只要有利于大家,尽管别人认为卑贱的工作,我也乐而为之,不以为耻');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (58, 58, 1, 'SINGLE_CHOICE', '我喜欢看电影或参加其他娱乐活动');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (59, 59, 1, 'SINGLE_CHOICE', '我喜欢从事需要精确技术的工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (60, 60, 1, 'SINGLE_CHOICE', '在有思想,有地位的长者面前,我总较为缄默');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (61, 61, 1, 'SINGLE_CHOICE', '就我来说,在大众前演讲或表演是一件不容易的事');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (62, 62, 1, 'SINGLE_CHOICE', '我宁愿');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (63, 63, 1, 'SINGLE_CHOICE', '纵使我做了一桩贻笑大方的事，我也仍然能够将它淡然忘却');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (64, 64, 1, 'SINGLE_CHOICE', '没有人会幸灾乐祸地希望我遭遇困难');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (65, 65, 1, 'SINGLE_CHOICE', '堂堂男子汉应该');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (66, 66, 1, 'SINGLE_CHOICE', '我喜欢解决别人已弄得一塌糊涂的问题');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (67, 67, 1, 'SINGLE_CHOICE', '我十分高兴的时候总有[好景不长]之感');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (68, 68, 1, 'SINGLE_CHOICE', '在一般困难处境下,我总能保持乐观');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (69, 69, 1, 'SINGLE_CHOICE', '迁居是一桩极不愉快的事');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (70, 70, 1, 'SINGLE_CHOICE', '在我年轻的时候,如果我和父母的意见不同,我经常');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (71, 71, 1, 'SINGLE_CHOICE', '我希望我的爱人能够使家庭');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (72, 72, 1, 'SINGLE_CHOICE', '我解决问题多数依靠');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (73, 73, 1, 'SINGLE_CHOICE', '需要[当机立断]时,我总');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (74, 74, 1, 'SINGLE_CHOICE', '最近,在一两桩事情上,我觉得自己是无辜受累');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (75, 75, 1, 'SINGLE_CHOICE', '我善于控制我的表情');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (76, 76, 1, 'SINGLE_CHOICE', '如果薪俸相等,我宁愿做');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (77, 77, 1, 'SINGLE_CHOICE', '[惊讶]与[新奇]犹如[惧怕]与');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (78, 78, 1, 'SINGLE_CHOICE', '下列三个分数中,哪一个与其他两个属不同类别:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (79, 79, 1, 'SINGLE_CHOICE', '不知什么缘故,有些人故意回避或冷淡我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (80, 80, 1, 'SINGLE_CHOICE', '我虽善意待人,却得不到好报');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (81, 81, 1, 'SINGLE_CHOICE', '我不喜欢那些夜郎自大,目空一切的人');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (82, 82, 1, 'SINGLE_CHOICE', '和一般人相比,我的朋友的确太少');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (83, 83, 1, 'SINGLE_CHOICE', '出于万不得已时,我才参加社交集会,否则我总设法回避');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (84, 84, 1, 'SINGLE_CHOICE', '在服务机关中,对上级的逢迎得当,比工作上的表现更为重要');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (85, 85, 1, 'SINGLE_CHOICE', '参加竞赛时,我看重的是竞赛活动,而不计较其成败');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (86, 86, 1, 'SINGLE_CHOICE', '我宁愿我所就的职业有');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (87, 87, 1, 'SINGLE_CHOICE', '我宁愿阅读');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (88, 88, 1, 'SINGLE_CHOICE', '有许多人不敢欺骗或犯罪,主要原因是怕受到惩罚');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (89, 89, 1, 'SINGLE_CHOICE', '我的父母(或保护人)从未很严格地要我事事顺从');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (90, 90, 1, 'SINGLE_CHOICE', '[百折不挠][再接再励]的精神似乎完全被现代人忽视了');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (91, 91, 1, 'SINGLE_CHOICE', '如果有人对我发怒,我总:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (92, 92, 1, 'SINGLE_CHOICE', '我希望大家都提倡');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (93, 93, 1, 'SINGLE_CHOICE', '无论在极高的屋顶上或极深的隧道中，我很少觉得胆怯不安');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (94, 94, 1, 'SINGLE_CHOICE', '我只要没有过错,不管人家怎样归咎于我,我总能心安理得');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (95, 95, 1, 'SINGLE_CHOICE', '凡是无法运用理智来解决的问题，有时就不得不靠权力来处理');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (96, 96, 1, 'SINGLE_CHOICE', '我十六、七岁时与异性朋友的交往');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (97, 97, 1, 'SINGLE_CHOICE', '我在交际场或所参加的组织中是一个活跃分子');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (98, 98, 1, 'SINGLE_CHOICE', '在人声噪杂中,我仍能不受妨碍,专心工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (99, 99, 1, 'SINGLE_CHOICE', '在某环境下,我常因困惑引起幻想而将工作搁置下来');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (100, 100, 1, 'SINGLE_CHOICE', '我很少用难堪的话去中伤别人的感情');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (101, 101, 1, 'SINGLE_CHOICE', '我更愿意做一名');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (102, 102, 1, 'SINGLE_CHOICE', '[理不胜辞]的意思是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (103, 103, 1, 'SINGLE_CHOICE', '[锄头]与[挖掘]犹如[刀子]与');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (104, 104, 1, 'SINGLE_CHOICE', '我常横过街道,以回避我不愿招乎的人');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (105, 105, 1, 'SINGLE_CHOICE', '在我倾听音乐时,如果人家高谈阔论');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (106, 106, 1, 'SINGLE_CHOICE', '在课堂上,如果我的意见与教师不同,我常');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (107, 107, 1, 'SINGLE_CHOICE', '我和异性友伴交谈时, 竭力避免涉及有关 [性] 的话题');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (108, 108, 1, 'SINGLE_CHOICE', '我待人接物的确不太成功');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (109, 109, 1, 'SINGLE_CHOICE', '每当考虑困难问题时,我总是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (110, 110, 1, 'SINGLE_CHOICE', '我所结交的朋友中,男女各占一半');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (111, 111, 1, 'SINGLE_CHOICE', '我宁可');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (112, 112, 1, 'SINGLE_CHOICE', '我宁为哲学家,而不做机械工程师');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (113, 113, 1, 'SINGLE_CHOICE', '如果我发现某人自私不义，我总不计一切指责他的弱点');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (114, 114, 1, 'SINGLE_CHOICE', '我善用心机去影响同伴,使他们能协助实现我的目标');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (115, 115, 1, 'SINGLE_CHOICE', '我喜欢做戏剧,音乐,歌剧等新闻采访工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (116, 116, 1, 'SINGLE_CHOICE', '当人们颂扬我时,我总觉得不好意思');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (117, 117, 1, 'SINGLE_CHOICE', '我以为现代最需要解决的问题是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (118, 118, 1, 'SINGLE_CHOICE', '我有时会无故地产生一种面临横祸的恐惧');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (119, 119, 1, 'SINGLE_CHOICE', '我在童年时,害怕黑暗的次数');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (120, 120, 1, 'SINGLE_CHOICE', '黄昏闲暇,我喜欢');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (121, 121, 1, 'SINGLE_CHOICE', '当人们批评我古怪时,我觉得');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (122, 122, 1, 'SINGLE_CHOICE', '在一个陌生的城市找住址时,我经常');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (123, 123, 1, 'SINGLE_CHOICE', '朋友们声明要在家休息时,我仍设法怂恿他们外出');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (124, 124, 1, 'SINGLE_CHOICE', '在就寝时,我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (125, 125, 1, 'SINGLE_CHOICE', '有人烦扰我时,我');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (126, 126, 1, 'SINGLE_CHOICE', '如果薪俸相等,我宁愿做一个');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (127, 127, 1, 'SINGLE_CHOICE', '时间永恒是比喻');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (128, 128, 1, 'SINGLE_CHOICE', '下列三项记号中,哪一项应紧接:XOOOOXXOOOXXX');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (129, 129, 1, 'SINGLE_CHOICE', '在陌生的地方,我仍能清楚地辩别东西南北的方向');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (130, 130, 1, 'SINGLE_CHOICE', '我的确比一般人幸运,因为我能从事自己热爱的工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (131, 131, 1, 'SINGLE_CHOICE', '如果我急于想借用别人的东西而物主恰又不在，我认为不告而取亦无大碍');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (132, 132, 1, 'SINGLE_CHOICE', '我喜欢向友人追述一些已往有趣的社交经验');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (133, 133, 1, 'SINGLE_CHOICE', '我更愿意做一名');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (134, 134, 1, 'SINGLE_CHOICE', '工作学习之余,我总要安排计划,不使时间浪费');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (135, 135, 1, 'SINGLE_CHOICE', '与人交际时,我常会无端地产生一种自卑感:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (136, 136, 1, 'SINGLE_CHOICE', '主动与陌生人交谈:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (137, 137, 1, 'SINGLE_CHOICE', '我喜欢的音乐,多数是:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (138, 138, 1, 'SINGLE_CHOICE', '我爱做[白日梦]即[完全沉浸于幻想之中]');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (139, 139, 1, 'SINGLE_CHOICE', '未来二十年的世界局势定将好');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (140, 140, 1, 'SINGLE_CHOICE', '童年时,我喜欢阅读');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (141, 141, 1, 'SINGLE_CHOICE', '我素来对机械、汽车、飞机等有兴趣');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (142, 142, 1, 'SINGLE_CHOICE', '我愿意做一个缓刑释放罪犯的管理监视人');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (143, 143, 1, 'SINGLE_CHOICE', '人们认为我只不过是一个能苦干,稍有成就的人而已');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (144, 144, 1, 'SINGLE_CHOICE', '在逆境中,我总能保持精神振奋');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (145, 145, 1, 'SINGLE_CHOICE', '我以为人工节育是解决世界经济与和平问题的要诀');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (146, 146, 1, 'SINGLE_CHOICE', '在工作中我喜欢独自筹划，不愿受别人的干涉');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (147, 147, 1, 'SINGLE_CHOICE', '我相信[上司不可能没有过错,但他仍有权做当权者]');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (148, 148, 1, 'SINGLE_CHOICE', '我总设法使自己不粗心大意,忽略细节');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (149, 149, 1, 'SINGLE_CHOICE', '与人争辩或险遭事故后，我常发抖，精疲力竭，不能安心工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (150, 150, 1, 'SINGLE_CHOICE', '没有医生处方,我从不乱用药:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (151, 151, 1, 'SINGLE_CHOICE', '为了培养个人的兴趣,我愿意参加');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (152, 152, 1, 'SINGLE_CHOICE', '星火,燎原对等于姑息');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (153, 153, 1, 'SINGLE_CHOICE', '[钟表]与[时间]犹如[载缝]与');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (154, 154, 1, 'SINGLE_CHOICE', '生动的梦境常常滋扰我的睡眠');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (155, 155, 1, 'SINGLE_CHOICE', '我过去曾撕毁一些禁止人们自由的布告');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (156, 156, 1, 'SINGLE_CHOICE', '在一个陌生的城市中,我会');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (157, 157, 1, 'SINGLE_CHOICE', '我宁愿服饰素洁大方,而不愿争奇斗艳惹人注目');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (158, 158, 1, 'SINGLE_CHOICE', '黄昏时,安静的娱乐远胜过热闹的宴会');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (159, 159, 1, 'SINGLE_CHOICE', '我常常明知故犯,不愿意接受好心的建议');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (160, 160, 1, 'SINGLE_CHOICE', '我总把[是非][善恶]作为判断或取舍的原则');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (161, 161, 1, 'SINGLE_CHOICE', '我工作时不喜欢有许多人在旁参观');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (162, 162, 1, 'SINGLE_CHOICE', '故意去为难一般有教养的人, 如医生, 教师等人的尊严, 是一件有趣的事:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (163, 163, 1, 'SINGLE_CHOICE', '在各种课程中,我较喜欢:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (164, 164, 1, 'SINGLE_CHOICE', '那些自以为是、道貌岸然的人最使我生气');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (165, 165, 1, 'SINGLE_CHOICE', '与平常循规蹈矩的人交谈');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (166, 166, 1, 'SINGLE_CHOICE', '我喜欢');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (167, 167, 1, 'SINGLE_CHOICE', '如果做民意投票时,我宁愿投票赞同');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (168, 168, 1, 'SINGLE_CHOICE', '我有时会无端地感到沮丧痛苦');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (169, 169, 1, 'SINGLE_CHOICE', '当我与立场相反的人辩论时,我主张');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (170, 170, 1, 'SINGLE_CHOICE', '我一向重感情而不重理智,因此我的观点常动摇不定');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (171, 171, 1, 'SINGLE_CHOICE', '我的学习效率多有赖于:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (172, 172, 1, 'SINGLE_CHOICE', '我宁选一个薪俸高的工作,不在乎有无保障;而不愿任薪俸低的固定工作');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (173, 173, 1, 'SINGLE_CHOICE', '在参加辩论以前,我总先把握住自己的立场');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (174, 174, 1, 'SINGLE_CHOICE', '我常被一些无所谓的琐事所烦扰:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (175, 175, 1, 'SINGLE_CHOICE', '我宁愿住在嘈杂的城市,而不愿住在安静的乡村');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (176, 176, 1, 'SINGLE_CHOICE', '我宁愿');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (177, 177, 1, 'SINGLE_CHOICE', '一人(  )事,众人受累.我对这句话的反应是');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (178, 178, 1, 'SINGLE_CHOICE', '望子成龙的家长往往(  )苗助长');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (179, 179, 1, 'SINGLE_CHOICE', '气侯的转变并不影响我的情绪:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (180, 180, 1, 'SINGLE_CHOICE', '因为我对于一切问题都有些见解，大家都公认我富于思想:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (181, 181, 1, 'SINGLE_CHOICE', '我讲话的声音:');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (182, 182, 1, 'SINGLE_CHOICE', '人们公认我是一个活跃热情的人');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (183, 183, 1, 'SINGLE_CHOICE', '我喜欢有旅行和变动机会的工作，而不计较工作本身之是否有保障');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (184, 184, 1, 'SINGLE_CHOICE', '我治事严格,凡事都务求正确尽善尽美');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (185, 185, 1, 'SINGLE_CHOICE', '在取回或归还东西时，我总仔细检查是否东西还保持原状');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (186, 186, 1, 'SINGLE_CHOICE', '我通常精力充沛,忙碌多事');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (187, 187, 1, 'SINGLE_CHOICE', '我确信我没有遗漏或不经心回答上面任何问题');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (188, 1, 2, 'YES_NO', '你是否有许多不同的业余爱好？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (189, 2, 2, 'YES_NO', '你是否在做任何事情以前都要停下来仔细思考？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (190, 3, 2, 'YES_NO', '你的心境是否常有起伏？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (191, 4, 2, 'YES_NO', '你曾有过明知是别人的功劳而你去接受奖励的事吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (192, 5, 2, 'YES_NO', '你是否健谈？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (193, 6, 2, 'YES_NO', '欠债会使你不安吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (194, 7, 2, 'YES_NO', '你曾无缘无故觉得“真是难受”吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (195, 8, 2, 'YES_NO', '你曾贪图过份外之物吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (196, 9, 2, 'YES_NO', '你是否在晚上小心翼翼地关好门窗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (197, 10, 2, 'YES_NO', '你是否比较活跃？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (198, 11, 2, 'YES_NO', '你在见到一小孩或一动物受折磨时是否会感到非常难过？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (199, 12, 2, 'YES_NO', '你是否常常为自己不该作而作了的事，不该说而说了的话而紧张吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (200, 13, 2, 'YES_NO', '你喜欢跳降落伞吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (201, 14, 2, 'YES_NO', '通常你能在热闹联欢会中尽情地玩吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (202, 15, 2, 'YES_NO', '你容易激动吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (203, 16, 2, 'YES_NO', '你曾经将自己的过错推给别人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (204, 17, 2, 'YES_NO', '你喜欢会见陌生人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (205, 18, 2, 'YES_NO', '你是否相信保险制度是一种好办法？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (206, 19, 2, 'YES_NO', '你是一个容易伤感情的人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (207, 20, 2, 'YES_NO', '你所有的习惯都是好的吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (208, 21, 2, 'YES_NO', '在社交场合你是否总不愿露头角？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (209, 22, 2, 'YES_NO', '你会服用奇异或危险作用的药物吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (210, 23, 2, 'YES_NO', '你常有“厌倦”之感吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (211, 24, 2, 'YES_NO', '你曾拿过别人的东西吗（那怕一针一线）？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (212, 25, 2, 'YES_NO', '你是否常爱外出？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (213, 26, 2, 'YES_NO', '你是否从伤害你所宠爱的人而感到乐趣？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (214, 27, 2, 'YES_NO', '你常为有罪恶之感所苦恼吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (215, 28, 2, 'YES_NO', '你在谈论中是否有时不懂装懂？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (216, 29, 2, 'YES_NO', '你是否宁愿去看书而不愿去多见人？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (217, 30, 2, 'YES_NO', '你有要伤害你的仇人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (218, 31, 2, 'YES_NO', '你觉得自己是一个神经过敏的人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (219, 32, 2, 'YES_NO', '对人有所失礼时你是否经常要表示歉意？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (220, 33, 2, 'YES_NO', '你有许多朋友吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (221, 34, 2, 'YES_NO', '你是否喜爱讲些有时确能伤害人的笑话？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (222, 35, 2, 'YES_NO', '你是一个多忧多虑的人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (223, 36, 2, 'YES_NO', '你在童年是否按照吩咐要做什么便做什么，毫无怨言？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (224, 37, 2, 'YES_NO', '你认为你是一个乐天派吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (225, 38, 2, 'YES_NO', '你很讲究礼貌和整洁吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (226, 39, 2, 'YES_NO', '你是否总在担心会发生可怕的事情？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (227, 40, 2, 'YES_NO', '你曾损坏或遗失过别人的东西吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (228, 41, 2, 'YES_NO', '交新朋友时一般是你采取主动吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (229, 42, 2, 'YES_NO', '当别人向你诉苦时，你是否容易理解他们的苦哀？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (230, 43, 2, 'YES_NO', '你认为自己很紧张，如同“拉紧的弦”一样吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (231, 44, 2, 'YES_NO', '在没有废纸篓时，你是否将废纸扔在地板上？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (232, 45, 2, 'YES_NO', '当你与别人在一起时，你是否言语很少？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (233, 46, 2, 'YES_NO', '你是否认为结婚制度是过时了，应该废止？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (234, 47, 2, 'YES_NO', '你是否有时感到自己可怜？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (235, 48, 2, 'YES_NO', '你是否有时有点自夸？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (236, 49, 2, 'YES_NO', '你是否很容易将一个沉寂的集会搞得活跃起来？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (237, 50, 2, 'YES_NO', '你是否讨厌那种小心翼翼地开车的人？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (238, 51, 2, 'YES_NO', '你为你的健康担忧吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (239, 52, 2, 'YES_NO', '你曾讲过什么人的坏话吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (240, 53, 2, 'YES_NO', '你是否喜欢对朋友讲笑话和有趣的故事？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (241, 54, 2, 'YES_NO', '你小时候曾对父母粗暴无礼吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (242, 55, 2, 'YES_NO', '你是否喜欢与人混在一起？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (243, 56, 2, 'YES_NO', '你如知道自己工作有错误，这会使你感到难过吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (244, 57, 2, 'YES_NO', '你患失眠吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (245, 58, 2, 'YES_NO', '你吃饭前必定洗手吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (246, 59, 2, 'YES_NO', '你常无缘无故感到无精打采和倦怠吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (247, 60, 2, 'YES_NO', '和别人玩游戏时，你有过欺骗行为吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (248, 61, 2, 'YES_NO', '你是否喜欢从事一些动作迅速的工作？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (249, 62, 2, 'YES_NO', '你的母亲是一位善良的妇人吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (250, 63, 2, 'YES_NO', '你是否常常觉得人生非常无味？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (251, 64, 2, 'YES_NO', '你曾利用过某人为自己取得好处吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (252, 65, 2, 'YES_NO', '你是否常常参加许多活动，超过你的时间所允许？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (253, 66, 2, 'YES_NO', '是否有几个人总在躲避你？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (254, 67, 2, 'YES_NO', '你是否为你的容貌而非常烦恼？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (255, 68, 2, 'YES_NO', '你是否觉得人们为了未来有保障而办理储蓄和保险所花的时间太多？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (256, 69, 2, 'YES_NO', '你曾有过不如死了为好的愿望吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (257, 70, 2, 'YES_NO', '如果有把握永远不会被别人发现，你会逃税吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (258, 71, 2, 'YES_NO', '你能使一个集会顺利进行吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (259, 72, 2, 'YES_NO', '你能克制自己不对人无礼吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (260, 73, 2, 'YES_NO', '遇到一次难堪的经历后，你是否在一段很长的时间内还感到难受？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (261, 74, 2, 'YES_NO', '你患有“神经过敏”吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (262, 75, 2, 'YES_NO', '你曾经故意说些什么来伤害别人的感情吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (263, 76, 2, 'YES_NO', '你与别人的友谊是否容易破裂，虽然不是你的过错？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (264, 77, 2, 'YES_NO', '你常感到孤单吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (265, 78, 2, 'YES_NO', '当人家寻你的差错,找你工作中的缺点时,你是否容易在精神上受挫伤？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (266, 79, 2, 'YES_NO', '你赴约会或上班曾迟到过吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (267, 80, 2, 'YES_NO', '你喜欢忙忙碌碌地过日子吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (268, 81, 2, 'YES_NO', '你愿意别人怕你吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (269, 82, 2, 'YES_NO', '你是否觉得有时浑身是劲，而有时又是懒洋洋的吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (270, 83, 2, 'YES_NO', '你有时把今天应做的事拖到明天去做吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (271, 84, 2, 'YES_NO', '别人认为你是生气勃勃吗？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (272, 85, 2, 'YES_NO', '别人是否对你说了许多谎话？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (273, 86, 2, 'YES_NO', '你是否容易对某些事物容易冒火？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (274, 87, 2, 'YES_NO', '当你犯了错误时，你是否常常愿意承认它？');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (275, 88, 2, 'YES_NO', '你会为一动物落入圈套被捉拿而感到很难过吗？');
...
insert into psychtestquestions(id, sub_id, test_id, type, description) values (276, 1, 3, 'YES_NO', '我喜欢看机械方面的杂志。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (277, 2, 3, 'YES_NO', '我的胃口很好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (278, 3, 3, 'YES_NO', '我早上起来的时候，多半觉得睡眠充足，头脑清醒。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (279, 4, 3, 'YES_NO', '我想我会喜欢图书管理员的工作。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (280, 5, 3, 'YES_NO', '我很容易被吵醒。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (281, 6, 3, 'YES_NO', '我喜欢看报纸上的犯罪新闻。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (282, 7, 3, 'YES_NO', '我的手脚经常是很暖和的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (283, 8, 3, 'YES_NO', '我的日常生活中，充满了使我感兴趣的事情。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (284, 9, 3, 'YES_NO', '我现在工作（学习）的能力，和从前差不多。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (285, 10, 3, 'YES_NO', '我的喉咙里总好象有一块东西堵着似的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (286, 11, 3, 'YES_NO', '一个人应该去了解自己的梦，并从中得到指导和警告。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (287, 12, 3, 'YES_NO', '我喜欢侦探小说或神秘小说。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (288, 13, 3, 'YES_NO', '我总是在很紧张的情况下工作。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (289, 14, 3, 'YES_NO', '我每个月至少有一二次拉肚子。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (290, 15, 3, 'YES_NO', '偶尔我会想到一些坏得说不出口的话。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (291, 16, 3, 'YES_NO', '我深信生活对我是残酷的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (292, 17, 3, 'YES_NO', '我的父亲是一个好人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (293, 18, 3, 'YES_NO', '我很少有大便不通的毛病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (294, 19, 3, 'YES_NO', '当我干一件新的工作时，总喜欢别人告诉我，我应该接近谁。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (295, 20, 3, 'YES_NO', '我的性生活是满意的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (296, 21, 3, 'YES_NO', '有时我非常想离开家。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (297, 22, 3, 'YES_NO', '有时我会哭一阵笑一阵，连自己也不能控制。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (298, 23, 3, 'YES_NO', '有恶心和呕吐的毛病，我很苦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (299, 24, 3, 'YES_NO', '似乎没有一个人了解我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (300, 25, 3, 'YES_NO', '我想当一个歌唱家。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (301, 26, 3, 'YES_NO', '当我处境困难的时候，我觉得最好是不开口。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (302, 27, 3, 'YES_NO', '有时我觉得有鬼附在身上。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (303, 28, 3, 'YES_NO', '当别人惹了我时，我觉得只要有机会就应报复是理所当然的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (304, 29, 3, 'YES_NO', '我有胃酸过多的毛病。一星期要犯好几次，我很苦恼。．');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (305, 30, 3, 'YES_NO', '有时我真想骂人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (306, 31, 3, 'YES_NO', '每隔几个晚上我就做噩梦。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (307, 32, 3, 'YES_NO', '我发现我很难把注意力集中到一件工作上。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (308, 33, 3, 'YES_NO', '我曾经有过很特别、很奇怪的体验。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (309, 34, 3, 'YES_NO', '我时常咳嗽。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (310, 35, 3, 'YES_NO', '假如不是有人和我作对，我一定会有更大的成就。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (311, 36, 3, 'YES_NO', '我很少担心自己的健康。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (312, 37, 3, 'YES_NO', '我从来没有因为我的性方面的行为出过事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (313, 38, 3, 'YES_NO', '小的时候，有一段时间我干过小偷小摸的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (314, 39, 3, 'YES_NO', '有时我真想摔东西。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (315, 40, 3, 'YES_NO', '有很多时候我宁愿坐着空想，而不愿做任何事情。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (316, 41, 3, 'YES_NO', '我曾一连几天，几个星期，几个月什么也不想干，因为总是提不起精神。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (317, 42, 3, 'YES_NO', '我家里人对我已选择的工作（或将要选择的职业）不满意。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (318, 43, 3, 'YES_NO', '我睡得不安，容易被惊醒。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (319, 44, 3, 'YES_NO', '我觉得我的头到处都疼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (320, 45, 3, 'YES_NO', '有时我也说假话。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (321, 46, 3, 'YES_NO', '我的判断力比以往任何时候都好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (322, 47, 3, 'YES_NO', '每星期至少有一二次，我突然觉得无缘无故地全身发热。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (323, 48, 3, 'YES_NO', '当我与人相处的时候听到别人谈论稀奇古怪的事，我就心烦。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (324, 49, 3, 'YES_NO', '最好是所有的法律全都不要。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (325, 50, 3, 'YES_NO', '有时我觉得我的灵魂离开了我的身体。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (326, 51, 3, 'YES_NO', '我的身体和我大多数朋友一样的健康。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (327, 52, 3, 'YES_NO', '遇到同学或不常见朋友，除非他们先向我打招呼，不然我就装作没看见。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (328, 53, 3, 'YES_NO', '一位牧师（和尚、道士、神父、阿訇等教士），能用祈祷和把手放在病人的头上来治病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (329, 54, 3, 'YES_NO', '认识我的人差不多都喜欢我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (330, 55, 3, 'YES_NO', '我从来没有因为胸部痛或心痛而感到苦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (331, 56, 3, 'YES_NO', '我小时候，曾经因为胡闹而受过学校的处分。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (332, 57, 3, 'YES_NO', '我和别人一见面就熟了（自来熟）。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (333, 58, 3, 'YES_NO', '一切事情都由老天爷安排好了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (334, 59, 3, 'YES_NO', '我时常听从某些人的指挥，其实他们还不如我高明。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (335, 60, 3, 'YES_NO', '我不是每天都看报纸上的每一篇社论。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (336, 61, 3, 'YES_NO', '我从未有过正常的生活。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (337, 62, 3, 'YES_NO', '我身体某些部分常有像火烧、刺痛、虫爬、麻木的感觉。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (338, 63, 3, 'YES_NO', '我的大便正常，不难控制。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (339, 64, 3, 'YES_NO', '有时我会不停地做一件事情，直到别人不耐烦为止。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (340, 65, 3, 'YES_NO', '我爱我的父亲。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (341, 66, 3, 'YES_NO', '我能在我周围看到其他人所看不到的东西、动物和人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (342, 67, 3, 'YES_NO', '我希望我能像别人那样快乐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (343, 68, 3, 'YES_NO', '我从未感到脖子（颈）后面疼痛。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (344, 69, 3, 'YES_NO', '和我性别相同的人对我有强烈的吸引力。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (345, 70, 3, 'YES_NO', '我过去经常喜欢玩丢手帕的游戏。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (346, 71, 3, 'YES_NO', '我觉得许多人喜欢夸大看书的不幸，以便得到别人的同情和帮助。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (347, 72, 3, 'YES_NO', '我为经常感到心口（胃）不舒服而烦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (348, 73, 3, 'YES_NO', '我是个重要人物。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (349, 74, 3, 'YES_NO', '男性：我总希望我是女的；女性：我从不因为我是女的遗憾。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (350, 75, 3, 'YES_NO', '我有时发怒。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (351, 76, 3, 'YES_NO', '我时常感到悲观失望。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (352, 77, 3, 'YES_NO', '我看爱情小说。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (353, 78, 3, 'YES_NO', '我喜欢诗。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (354, 79, 3, 'YES_NO', '我的感情不容易受伤害。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (355, 80, 3, 'YES_NO', '我有时捉弄动物。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (356, 81, 3, 'YES_NO', '我想我会喜欢干森林管理员那一类的工作。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (357, 82, 3, 'YES_NO', '和人争辩的时候，我常争不过别人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (358, 83, 3, 'YES_NO', '任何人只要他有能力，而且愿意努力工作是能成功的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (359, 84, 3, 'YES_NO', '近来，我觉得很容易放弃对某些事务的希望。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (360, 85, 3, 'YES_NO', '有时我被别人的东西，如鞋、手套等强烈吸引，虽然这些东西对我毫无用处，但我总想摸摸它或把它偷来。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (361, 86, 3, 'YES_NO', '我确实缺少自信心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (362, 87, 3, 'YES_NO', '我愿意做一名花匠。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (363, 88, 3, 'YES_NO', '我总觉得人生是有价值的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (364, 89, 3, 'YES_NO', '要使大多数人相信事实的真相，是要经过一番辩论的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (365, 90, 3, 'YES_NO', '有时我将今天应该做的事，拖到明天去做。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (366, 91, 3, 'YES_NO', '我不在乎别人拿我开玩笑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (367, 92, 3, 'YES_NO', '我想当个护士。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (368, 93, 3, 'YES_NO', '我觉得大多数人为了向上爬而不惜说谎。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (369, 94, 3, 'YES_NO', '许多事情，我做过以后就后悔了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (370, 95, 3, 'YES_NO', '我几乎每星期都去教堂（或常去寺庙）。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (371, 96, 3, 'YES_NO', '我几乎没有和家里人吵过嘴。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (372, 97, 3, 'YES_NO', '有时我有一种强烈的冲动，去做一些惊人或有害的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (373, 98, 3, 'YES_NO', '我相信善有善报，恶有恶报。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (374, 99, 3, 'YES_NO', '我喜欢热闹的聚会。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (375, 100, 3, 'YES_NO', '我碰到一些千头万绪的问题，使我感到犹豫不决。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (376, 101, 3, 'YES_NO', '我认为女的在性生活方面，应该和男的有同等的自由。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (377, 102, 3, 'YES_NO', '我认为最难的是控制我自己。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (378, 103, 3, 'YES_NO', '我很少有肌肉抽筋或颤抖的毛病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (379, 104, 3, 'YES_NO', '我似乎对什么事情都不在乎。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (380, 105, 3, 'YES_NO', '我身体不舒服的时候，有时发脾气。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (381, 106, 3, 'YES_NO', '我总觉得我自己好像做错了什么事或犯了什么罪。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (382, 107, 3, 'YES_NO', '我经常是快乐的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (383, 108, 3, 'YES_NO', '我时常觉得头胀栓塞似的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (384, 109, 3, 'YES_NO', '有些人太霸道，即使我明知他们是对的，也要和他们对着干。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (385, 110, 3, 'YES_NO', '有人想害我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (386, 111, 3, 'YES_NO', '我从来没有为寻求刺激而去做危险的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (387, 112, 3, 'YES_NO', '我时常认为必须坚持那些我认为正确的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (388, 113, 3, 'YES_NO', '我相信法制。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (389, 114, 3, 'YES_NO', '我常觉得头上好像有一根绷得紧紧的带子。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (390, 115, 3, 'YES_NO', '我相信人死后会有“来世”。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (391, 116, 3, 'YES_NO', '我更喜欢我下了赌注的比赛和游戏。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (392, 117, 3, 'YES_NO', '大部分人之所以是诚实的，主要是因为怕被人识破。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (393, 118, 3, 'YES_NO', '我在上学的时候，有时因胡闹而被领导叫去。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (394, 119, 3, 'YES_NO', '我说话总是那样不快也不慢，不含糊也不嘶哑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (395, 120, 3, 'YES_NO', '我在外边和朋友们一起吃饭的时候，比在家规矩得多。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (396, 121, 3, 'YES_NO', '我相信有人暗算我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (397, 122, 3, 'YES_NO', '我似乎和我周围的人一样精明能干。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (398, 123, 3, 'YES_NO', '我相信有人在跟踪我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (399, 124, 3, 'YES_NO', '大多数人不惜用不正当的手段谋取利益，也不愿失掉机会。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (400, 125, 3, 'YES_NO', '我的胃有很多毛病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (401, 126, 3, 'YES_NO', '我喜欢戏剧。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (402, 127, 3, 'YES_NO', '我知道我的烦恼是谁造成的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (403, 128, 3, 'YES_NO', '看到血的时候，我既不害怕，也不难受。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (404, 129, 3, 'YES_NO', '我自己常弄不清为什么这样爱生气和发牢骚。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (405, 130, 3, 'YES_NO', '我从来没有吐过血，或咳过血。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (406, 131, 3, 'YES_NO', '我不为得病而担心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (407, 132, 3, 'YES_NO', '我喜欢栽花或采集花草。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (408, 133, 3, 'YES_NO', '我从来没有放纵自己发生过任何不正常的性行为。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (409, 134, 3, 'YES_NO', '有时我的思想跑得太快都来不及表达出来。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (410, 135, 3, 'YES_NO', '假如我能不买票白看电影，而且不会被人发觉，我可能会去做的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (411, 136, 3, 'YES_NO', '如果别人待我好，我常常怀疑他们别有用心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (412, 137, 3, 'YES_NO', '我相信我的家庭生活，和我所认识的许多人一样，幸福快乐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (413, 138, 3, 'YES_NO', '批评和责骂都使我非常伤心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (414, 139, 3, 'YES_NO', '有时我仿佛觉得我必须伤害自己或别人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (415, 140, 3, 'YES_NO', '我喜欢做饭烧菜。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (416, 141, 3, 'YES_NO', '我的行为多半受周围人的喜欢所支配。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (417, 142, 3, 'YES_NO', '有时我觉得我真是毫无用处。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (418, 143, 3, 'YES_NO', '小时候我曾加入过一个团伙，有福共享，有祸同当。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (419, 144, 3, 'YES_NO', '我喜欢当兵。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (420, 145, 3, 'YES_NO', '有时我想借故和别人打架。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (421, 146, 3, 'YES_NO', '我喜欢到处乱逛，如果不行，我就不高兴。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (422, 147, 3, 'YES_NO', '由于我经常不能当机立断，因而失去许多良机。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (423, 148, 3, 'YES_NO', '当我正在做一件重要事情的时候，如果有人向我请教或打扰我，我会不耐烦的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (424, 149, 3, 'YES_NO', '我以前写过日记。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (425, 150, 3, 'YES_NO', '做游戏的时候，我只愿赢而不愿输。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (426, 151, 3, 'YES_NO', '有人一直想毒死我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (427, 152, 3, 'YES_NO', '大多数晚上我睡觉时，不受什么思想干扰。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (428, 153, 3, 'YES_NO', '近几年来大部分时间，我的身体都很好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (429, 154, 3, 'YES_NO', '我从来没有过抽风的毛病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (430, 155, 3, 'YES_NO', '现在我的体重既没有增加也没有减轻。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (431, 156, 3, 'YES_NO', '有一段时间，我自己做过的事情全不记得了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (432, 157, 3, 'YES_NO', '我觉得我时常无缘无故地受到惩罚。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (433, 158, 3, 'YES_NO', '我容易哭。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (434, 159, 3, 'YES_NO', '我不能象从前那样理解我所读的东西了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (435, 160, 3, 'YES_NO', '在我一生中，我从来没有感觉到像现在这么好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (436, 161, 3, 'YES_NO', '有时候我觉得我的头顶一碰就疼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (437, 162, 3, 'YES_NO', '我痛恨别人以不正当的手段捉弄我，使我不得不认输。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (438, 163, 3, 'YES_NO', '我不容易疲倦。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (439, 164, 3, 'YES_NO', '我喜欢研究和阅读与我目前工作有关的东西。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (440, 165, 3, 'YES_NO', '我喜欢结识一些重要人物，这样会使我感到自己也很重要。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (441, 166, 3, 'YES_NO', '我很害怕从高处往下看。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (442, 167, 3, 'YES_NO', '即使我家里有人犯法，我也不会紧张。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (443, 168, 3, 'YES_NO', '我的脑子有点毛病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (444, 169, 3, 'YES_NO', '我不怕管钱。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (445, 170, 3, 'YES_NO', '我不在乎别人对我有什么看法。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (446, 171, 3, 'YES_NO', '在聚会当中，尽管有人出风头，如果让我也这样做，我会感到很不舒服。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (447, 172, 3, 'YES_NO', '我时常需要努力使自己不显出怕羞的样子。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (448, 173, 3, 'YES_NO', '我过去喜欢上学。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (449, 174, 3, 'YES_NO', '我从来没有昏倒过。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (450, 175, 3, 'YES_NO', '我很少头昏眼花。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (451, 176, 3, 'YES_NO', '我不大怕蛇。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (452, 177, 3, 'YES_NO', '我母亲是个好人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (453, 178, 3, 'YES_NO', '我的记忆力似乎不错。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (454, 179, 3, 'YES_NO', '有关性方面的问题，使我烦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (455, 180, 3, 'YES_NO', '我觉得我遇到生人的时候就不知道说什么好了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (456, 181, 3, 'YES_NO', '无聊的时候，我就会惹事寻求开心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (457, 182, 3, 'YES_NO', '我怕自己会发疯。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (458, 183, 3, 'YES_NO', '我反对把钱给乞丐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (459, 184, 3, 'YES_NO', '我时常听到说话的声音，而不知道它是从那里来的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (460, 185, 3, 'YES_NO', '我的听觉显然和大多数人一样好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (461, 186, 3, 'YES_NO', '当我要做一件事的时候，我常发觉我的手在抖。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (462, 187, 3, 'YES_NO', '我的双手并没有变得笨拙不灵。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (463, 188, 3, 'YES_NO', '我能阅读很长的时间，而眼睛不觉得累。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (464, 189, 3, 'YES_NO', '许多时候，我觉得浑身无力。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (465, 190, 3, 'YES_NO', '我很少头痛。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (466, 191, 3, 'YES_NO', '有时，当我难为情的时候，会出很多汗，这使我非常苦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (467, 192, 3, 'YES_NO', '我走路时保持平稳并不困难。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (468, 193, 3, 'YES_NO', '我没哮喘这一类病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (469, 194, 3, 'YES_NO', '我曾经有过几次突然不能控制自己的行动或言语，但当时我的头脑还很清醒。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (470, 195, 3, 'YES_NO', '我所认识的人里不是各个我都喜欢。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (471, 196, 3, 'YES_NO', '我喜欢到我从来没有到过的地方去游览。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (472, 197, 3, 'YES_NO', '有人一直想抢我的东西。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (473, 198, 3, 'YES_NO', '我很少空想。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (474, 199, 3, 'YES_NO', '我们应该把有关性方面的主要知识告诉孩子。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (475, 200, 3, 'YES_NO', '有人想窃取我的思想和计划。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (476, 201, 3, 'YES_NO', '但愿我不像现在这样的害羞。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (477, 202, 3, 'YES_NO', '我相信我是一个被谴责的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (478, 203, 3, 'YES_NO', '假若我是一个新闻记者，我将喜欢报道戏剧界的新闻。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (479, 204, 3, 'YES_NO', '我喜欢做一个新闻记者。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (480, 205, 3, 'YES_NO', '有时我控制不住想要偷点东西。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (481, 206, 3, 'YES_NO', '我很信神，程度超过多数人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (482, 207, 3, 'YES_NO', '我喜欢许多不同种类的游戏和娱乐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (483, 208, 3, 'YES_NO', '我喜欢和异性说笑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (484, 209, 3, 'YES_NO', '我相信我的罪恶是不可饶恕的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (485, 210, 3, 'YES_NO', '每一种东西吃起来味道都是不一样的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (486, 211, 3, 'YES_NO', '我白天睡觉，晚上却睡不着。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (487, 212, 3, 'YES_NO', '我家里的人把我当做小孩子，而不把我当做大人看待。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (488, 213, 3, 'YES_NO', '走路时，我很小心地跨过人行道上的接缝。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (489, 214, 3, 'YES_NO', '我从来没有为皮肤上长点东西而烦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (490, 215, 3, 'YES_NO', '我曾经饮酒过度。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (491, 216, 3, 'YES_NO', '和别人的家庭比较，我的家庭缺乏爱和温暖。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (492, 217, 3, 'YES_NO', '我时常感到自己在为某些事而担心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (493, 218, 3, 'YES_NO', '当看到动物受折磨的时候，我并不觉得特别难受。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (494, 219, 3, 'YES_NO', '我想我会喜欢建筑承包的工作。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (495, 220, 3, 'YES_NO', '我爱我母亲。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (496, 221, 3, 'YES_NO', '我喜欢科学。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (497, 222, 3, 'YES_NO', '即使我以后不能报答，我也愿向朋友求助。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (498, 223, 3, 'YES_NO', '我很喜欢打猎。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (499, 224, 3, 'YES_NO', '我父母经常反对那些和我交往的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (500, 225, 3, 'YES_NO', '有时我也会说说人家的闲话。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (501, 226, 3, 'YES_NO', '我家里有些人的习惯，使我非常讨厌。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (502, 227, 3, 'YES_NO', '人家告诉我，我在睡觉中起来走路（梦游）。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (503, 228, 3, 'YES_NO', '有时我觉得我非常容易做出决定。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (504, 229, 3, 'YES_NO', '我喜欢同时参加几个团体。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (505, 230, 3, 'YES_NO', '我从来没有感到心慌气短。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (506, 231, 3, 'YES_NO', '我喜欢谈论两性方面的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (507, 232, 3, 'YES_NO', '我曾经立志要过一种以责任为重的生活，我一直照此谨慎从事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (508, 233, 3, 'YES_NO', '我有时阻止别人做某些事，并不是因为那种事有多大影响，而是在道义上我应该干预他。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (509, 234, 3, 'YES_NO', '我很容易生气，但很快就平静下来。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (510, 235, 3, 'YES_NO', '我已独立自主，不受家庭的约束。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (511, 236, 3, 'YES_NO', '我有很多心事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (512, 237, 3, 'YES_NO', '我的亲属几乎全都同情我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (513, 238, 3, 'YES_NO', '有时我十分烦躁，坐立不安。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (514, 239, 3, 'YES_NO', '我曾经失恋过。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (515, 240, 3, 'YES_NO', '我从来不为我的外貌而发愁。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (516, 241, 3, 'YES_NO', '我常梦到一些不可告人的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (517, 242, 3, 'YES_NO', '我相信我并不比别人更为神经过敏。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (518, 243, 3, 'YES_NO', '我几乎没有什么地方疼痛。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (519, 244, 3, 'YES_NO', '我的做事方法容易被人误解。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (520, 245, 3, 'YES_NO', '我的父母和家里人对我过于挑剔。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (521, 246, 3, 'YES_NO', '我脖子（颈）上时常出现红斑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (522, 247, 3, 'YES_NO', '我有理由嫉妒家里的某些人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (523, 248, 3, 'YES_NO', '我有时无缘无故地，甚至在不顺利的时候也会觉得非常快乐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (524, 249, 3, 'YES_NO', '我相信阴间有魔鬼和地狱。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (525, 250, 3, 'YES_NO', '有人想把世界上所能得到的东西都夺到手，我绝不责怪他。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (526, 251, 3, 'YES_NO', '我曾经发呆（发愣）停止活动，不知道周围发生了什么事情。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (527, 252, 3, 'YES_NO', '谁也不关心谁的遭遇。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (528, 253, 3, 'YES_NO', '有些人所做的事，虽然我认为是错的，但我仍然能够友好地对待他们。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (529, 254, 3, 'YES_NO', '我喜欢和一些能互相开玩笑的人在一起。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (530, 255, 3, 'YES_NO', '在选举的时候，有时我会选出我不熟悉的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (531, 256, 3, 'YES_NO', '报纸上只有漫画最有趣。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (532, 257, 3, 'YES_NO', '凡是我所做的事，我都指望能够成功。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (533, 258, 3, 'YES_NO', '我相信有神。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (534, 259, 3, 'YES_NO', '做什么事情，我都感到难以开头。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (535, 260, 3, 'YES_NO', '在学校里，我是个笨学生。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (536, 261, 3, 'YES_NO', '如果我是个画家，我喜欢画花。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (537, 262, 3, 'YES_NO', '我虽然相貌不好看，也不因此而苦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (538, 263, 3, 'YES_NO', '即使在冷天我也很容易出汗。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (539, 264, 3, 'YES_NO', '我十分自信。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (540, 265, 3, 'YES_NO', '对任何人都不信任，是比较安全的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (541, 266, 3, 'YES_NO', '每星期至少有一两次我十分兴奋。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (542, 267, 3, 'YES_NO', '人多的时候，我不知道说些什么话好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (543, 268, 3, 'YES_NO', '在我心情不好的时候，总会有一些事使我高兴起来。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (544, 269, 3, 'YES_NO', '我能很容易使人怕我，有时故意这样做来寻开心。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (545, 270, 3, 'YES_NO', '我离家外出的时候，从来不担心家里门窗是否关好锁好了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (546, 271, 3, 'YES_NO', '我不责怪一个到处找没趣的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (547, 272, 3, 'YES_NO', '我有时精力充沛。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (548, 273, 3, 'YES_NO', '我的身体上有一两处麻木了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (549, 274, 3, 'YES_NO', '我的视力和往年一样好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (550, 275, 3, 'YES_NO', '有人控制着我的思想。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (551, 276, 3, 'YES_NO', '我喜欢小孩子。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (552, 277, 3, 'YES_NO', '有时我非常欣赏骗子的机智，我甚至希望他能侥幸混过去。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (553, 278, 3, 'YES_NO', '我时常觉得有些陌生人用挑剔的眼光盯着我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (554, 279, 3, 'YES_NO', '我每天喝特别多水。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (555, 280, 3, 'YES_NO', '大多数人交朋友是因为朋友对他们有用。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (556, 281, 3, 'YES_NO', '我很少注意我的耳鸣。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (557, 282, 3, 'YES_NO', '通常我爱家里的人偶尔也恨他们。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (558, 283, 3, 'YES_NO', '假使我是一个新闻记者，我将很愿意报道体育新闻。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (559, 284, 3, 'YES_NO', '我确信别人正在议论我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (560, 285, 3, 'YES_NO', '偶尔我听了下流的笑话也会发笑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (561, 286, 3, 'YES_NO', '我独自一个人的时候，感到更快乐。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (562, 287, 3, 'YES_NO', '我害怕的事比我的朋友们少得多。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (563, 288, 3, 'YES_NO', '恶心呕吐的毛病使我苦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (564, 289, 3, 'YES_NO', '当一个罪犯可以通过能言善辩的律师开脱罪责时，我对法律感到厌恶。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (565, 290, 3, 'YES_NO', '我总是在很紧张的情况下工作的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (566, 291, 3, 'YES_NO', '在我这一生中，至少有一两次我觉得有人用催眠术指使我做了一些事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (567, 292, 3, 'YES_NO', '我不愿意同人讲话，除非他先开口。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (568, 293, 3, 'YES_NO', '有人一直想要影响我的思想。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (569, 294, 3, 'YES_NO', '我从来没有犯过法。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (570, 295, 3, 'YES_NO', '我喜欢看《红楼梦》这一类的小说。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (571, 296, 3, 'YES_NO', '有些时候，我会无缘无故地觉得非常愉快。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (572, 297, 3, 'YES_NO', '我喜欢我不再受那种有关性方面的念头所困扰。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (573, 298, 3, 'YES_NO', '假若有几个人闯了祸，他们最好选编一套假话，而且不改口。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (574, 299, 3, 'YES_NO', '我认为我比大多数人更重感情。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (575, 300, 3, 'YES_NO', '在我的一生当中，从来没有喜欢过洋娃娃。 ');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (576, 301, 3, 'YES_NO', '许多时候，生活对我来说是一件吃力的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (577, 302, 3, 'YES_NO', '我从来没有因为我的性方面的行为出过事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (578, 303, 3, 'YES_NO', '对于某些事情我很敏感，以致使我不能提起。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (579, 304, 3, 'YES_NO', '在学校里，要我在班上发言，是非常困难的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (580, 305, 3, 'YES_NO', '即使和人们在一起，我还是经常感到孤单。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (581, 306, 3, 'YES_NO', '应得的同情，我全得到了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (582, 307, 3, 'YES_NO', '我拒绝玩那些我玩不好的游戏。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (583, 308, 3, 'YES_NO', '有时我非常想离开家。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (584, 309, 3, 'YES_NO', '我交朋友差不多和别人一样的容易。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (585, 310, 3, 'YES_NO', '我的性生活是满意的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (586, 311, 3, 'YES_NO', '我小的时候，有一段时间我干过小偷小摸的事。 ');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (587, 312, 3, 'YES_NO', '我不喜欢有人在我身旁。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (588, 313, 3, 'YES_NO', '有人不将自己的贵重物品保管好因而引起别人偷窃，这种人和小偷一样应受责备。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (589, 314, 3, 'YES_NO', '偶尔我会想到一些坏得说不出口的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (590, 315, 3, 'YES_NO', '我深信生活对我是残酷的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (591, 316, 3, 'YES_NO', '我想差不多每个人，都会为了避免麻烦说点假话。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (592, 317, 3, 'YES_NO', '我比大多数人更敏感。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (593, 318, 3, 'YES_NO', '我的日常生活中，充满着使我感兴趣的事情。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (594, 319, 3, 'YES_NO', '大多数人都是内心不愿意挺身而出去帮助别人的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (595, 320, 3, 'YES_NO', '我的梦有好些是关于性方面的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (596, 321, 3, 'YES_NO', '我很容易感到不知所措。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (597, 322, 3, 'YES_NO', '我为金钱和事业忧虑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (598, 323, 3, 'YES_NO', '我曾经有过很特别、很奇怪的体验。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (599, 324, 3, 'YES_NO', '我从来没有爱上过任何人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (600, 325, 3, 'YES_NO', '我家里有些人所做的事，使我吃惊。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (601, 326, 3, 'YES_NO', '有时我会哭一阵，笑一阵，连自己也不能控制。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (602, 327, 3, 'YES_NO', '我的母亲或父亲时常要我服从他，甚至我认为是不合理的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (603, 328, 3, 'YES_NO', '我发现我很难把注意力集中到一件工作上。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (604, 329, 3, 'YES_NO', '我几乎从不做梦。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (605, 330, 3, 'YES_NO', '我从来没有瘫痪过，或是感到肌肉非常软弱无力。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (606, 331, 3, 'YES_NO', '假如不是别人和我作对，我一定会有更大的成就。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (607, 332, 3, 'YES_NO', '即使我没有感冒，我有时也会发不出声音或声音改变。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (608, 333, 3, 'YES_NO', '似乎没有人能了解我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (609, 334, 3, 'YES_NO', '有时我会闻到奇怪的气味。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (610, 335, 3, 'YES_NO', '我不能专心于一件事情上。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (611, 336, 3, 'YES_NO', '我很容易对人感到不耐烦。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (612, 337, 3, 'YES_NO', '我几乎整天都在为某件事或某个人而焦虑。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (613, 338, 3, 'YES_NO', '我所操心的事，远远超过了我所应该操心的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (614, 339, 3, 'YES_NO', '大部分时间，我觉得我还是死了的好。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (615, 340, 3, 'YES_NO', '有时我会兴奋得难以入睡。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (616, 341, 3, 'YES_NO', '有时我的听觉太灵敏了，反而使我感到烦恼。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (617, 342, 3, 'YES_NO', '听人对我所说的话，我立刻就忘记了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (618, 343, 3, 'YES_NO', '哪怕是琐碎小事，我也再三考虑才去做。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (619, 344, 3, 'YES_NO', '有时为了避免和某些人相遇，我会绕道而行。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (620, 345, 3, 'YES_NO', '我常常觉得好像一切都不是真的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (621, 346, 3, 'YES_NO', '我有一个习惯，喜欢数一些不重要的东西，像路上的电线杆等等。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (622, 347, 3, 'YES_NO', '我没有真正想伤害我的仇人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (623, 348, 3, 'YES_NO', '我提防那些对我过分亲近的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (624, 349, 3, 'YES_NO', '我有一些奇怪和特别的念头。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (625, 350, 3, 'YES_NO', '在我独处的时候，我听到奇怪的声音。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (626, 351, 3, 'YES_NO', '当我必须短期离家出门的时候，我会感到心神不安。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (627, 352, 3, 'YES_NO', '我怕一些东西或人，虽然我明知他们是不会伤害我的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (628, 353, 3, 'YES_NO', '如果屋子里已经有人聚在一起谈话，这时要我一个人进去，我一点也不怕。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (629, 354, 3, 'YES_NO', '我害怕使用刀子或任何尖利的东西。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (630, 355, 3, 'YES_NO', '有时我喜欢折磨我所爱的人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (631, 356, 3, 'YES_NO', '我似乎比别人更难于集中注意力。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (632, 357, 3, 'YES_NO', '有好几次我放弃正在做的事，因为我感觉自己的能力太差了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (633, 358, 3, 'YES_NO', '我脑子里常常出现一些坏的可怕的字眼，却又无法摆脱它们。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (634, 359, 3, 'YES_NO', '有时一些无关紧要的念头缠着我，使我好多天都感到不安。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (635, 360, 3, 'YES_NO', '几乎每天都有使我害怕的事发生。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (636, 361, 3, 'YES_NO', '我总是将事情看得严重些。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (637, 362, 3, 'YES_NO', '我比大多数人更敏感。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (638, 363, 3, 'YES_NO', '有时我喜欢受到我心爱的人的折磨。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (639, 364, 3, 'YES_NO', '有人用侮辱性和下流的话议论我。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (640, 365, 3, 'YES_NO', '我呆在屋里总感到不安。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (641, 366, 3, 'YES_NO', '即使和人们在一起，我仍经常感到孤单。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (642, 367, 3, 'YES_NO', '我并不是特别害羞拘谨。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (643, 368, 3, 'YES_NO', '有时我的头脑似乎比平时迟钝。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (644, 369, 3, 'YES_NO', '在社交场合，我多半是一个人坐着，或者只跟另一个人坐在一起，而不到人群里去。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (645, 370, 3, 'YES_NO', '人们常使我失望。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (646, 371, 3, 'YES_NO', '我很喜欢参加舞会。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (647, 372, 3, 'YES_NO', '有时我常感到困难重重，无法克服。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (648, 373, 3, 'YES_NO', '我常想：“我要能再成为一个孩子就好了。”');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (649, 374, 3, 'YES_NO', '如果给我机会，我一定能做些对世界大有益处的事。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (650, 375, 3, 'YES_NO', '我时常遇见一些所谓的专家，他们并不比我高明。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (651, 376, 3, 'YES_NO', '当我听说我所熟悉的人成功了，我就觉得自己失败了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (652, 377, 3, 'YES_NO', '如果有机会，我一定能成为一个人民的好领袖。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (653, 378, 3, 'YES_NO', '下流的故事使我感到不好意思。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (654, 379, 3, 'YES_NO', '一般来说人们要求别人尊重他们的权利比较多，而他们却很少尊重别人的权利。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (655, 380, 3, 'YES_NO', '我总想把好的故事记住，讲给别人听。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (656, 381, 3, 'YES_NO', '我喜欢搞输赢不大的赌博。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (657, 382, 3, 'YES_NO', '为了可以和人们在一起，我喜欢社交活动。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (658, 383, 3, 'YES_NO', '我喜欢人多热闹的场合。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (659, 384, 3, 'YES_NO', '当我和一群活泼的朋友在一起的时候，我的烦恼就消失了。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (660, 385, 3, 'YES_NO', '当人们说我班级人的闲话时，我从来不参与。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (661, 386, 3, 'YES_NO', '只要我开始做一件事，就很难放下，哪怕是暂时的。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (662, 387, 3, 'YES_NO', '我的小便不困难，也不难控制。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (663, 388, 3, 'YES_NO', '我常发现别人妒忌我的好主意，因为他们没能先想到。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (664, 389, 3, 'YES_NO', '只要有可能，我就避开人群。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (665, 390, 3, 'YES_NO', '我不怕见生人。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (666, 391, 3, 'YES_NO', '记得我曾经为了不想做某件事而装过病。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (667, 392, 3, 'YES_NO', '在火车和公共汽车上，我常跟陌生人交谈。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (668, 393, 3, 'YES_NO', '当事情不顺利的时候，我就想立即放弃。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (669, 394, 3, 'YES_NO', '我不愿意让人家知道我对于事物的态度。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (670, 395, 3, 'YES_NO', '有些时间，我感到劲头十足，以至一连好几天都不需要睡觉。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (671, 396, 3, 'YES_NO', '在人群中，如果叫我带头发言，或对我所熟悉的事情发表意见，我并不感到不好意思。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (672, 397, 3, 'YES_NO', '我喜欢聚会和社交活动。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (673, 398, 3, 'YES_NO', '面对困难或危险的时候，我总退缩不前。');
insert into psychtestquestions(id, sub_id, test_id, type, description) values (674, 399, 3, 'YES_NO', '我原来想做的事，假若别人认为不值得做，我很容易放弃。');
